...
class RenderablePortlets_Controller extends Extension
{
    ...
    As Silverstripe can only deal with a single parameter string with no spaces,
    split the params by a pipe character. These parameters are as follows:
    * @param model The DataObject class that we wish to show
    * @param where The filter to use (i.e. the where clause, leave blank to
      ignore)
    * @param ordering The order (descending) to show items (normally the home
      page is for the most recent things)
